...
//@SpringApplicationConfiguration(classes = Array(classOf[SpringRestApplication]))
//@WebAppConfiguration
//@IntegrationTest(Array("server.port:8000"))
...
//    //this.applicationContext = SpringRestApplication.start(port = port)
//    Kamon.start()
//  }
//
